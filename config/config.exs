...
config :sitevoice,
  ...
  ash_domains: [Sitevoice.Accounts, Sitevoice.Projects, Sitevoice.Reporting, Sitevoice.Integrations]
...
config :sitevoice, SitevoiceWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: SitevoiceWeb.ErrorHTML, json: SitevoiceWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Sitevoice.PubSub,
  live_view: [signing_salt: "p9jMHy5V"]
...
config :sitevoice, Sitevoice.Mailer, adapter: Swoosh.Adapters.Local
