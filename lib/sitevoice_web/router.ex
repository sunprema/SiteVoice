defmodule SitevoiceWeb.Router do
  use SitevoiceWeb, :router
  ...
  scope "/api/json" do
    ...
    forward "/", SitevoiceWeb.AshJsonApiRouter
  end
  ...
  scope "/", SitevoiceWeb do
    ...
    confirm_route Sitevoice.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [SitevoiceWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Sitevoice.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [SitevoiceWeb.AuthOverrides, Elixir.AshAuthentication.Phoenix.Overrides.DaisyUI]
    )
  end
  ...
  # scope "/api", SitevoiceWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:sitevoice, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: SitevoiceWeb.Telemetry
